...
import com.gtw.bambufilamentloader.model.domain.DetailedFilamentType
import com.gtw.bambufilamentloader.model.domain.FilamentSpool
import com.gtw.bambufilamentloader.model.domain.TrayInfoIndex
...
suspend fun parseFilamentSpool(tag: Tag): Result<FilamentSpool> {
            ...
            try {
                ...
                Result.success(
                    FilamentSpool(
                        ...
                        filamentType = String(
                            extractBlockBytes(0, 2).takeUntilNull(),
                            Charsets.US_ASCII
                        ),
                        ...
                        filamentColour = extractBlockBytes(1, 1).slice(0..3).let {
                            ...
                            Log.d("NFC", "Colour: $red, $green, $blue, $alpha")
...
//                        producedAt = extractBlockBytes(2, 2).slice(0..3).toByteArray().let {
                ...
                Result.failure<FilamentSpool>(e)
            } finally {
                mifare.close()
            }
